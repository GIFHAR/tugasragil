                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4" style="height: 250px;">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Harga PAUD</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <h4 class="small font-weight-bold">Rp.500.0000-Rp.1.000.000  </h4>
                                    <div class="progress mb-4">
                            ...
                            <div class="col-lg-16 mb-4">
                                ...
                                <div class="card mb-4 py-3 border-bottom-primary">
                                    <div class="card-body">
                                        <div class="card-body">
                                            PAUD      = 20-75 m<sup>2</sup><br>
                                            TK        = 205-206 m<sup>2</sup><br>
                                            Pesantren = 90-181 m<sup>2</sup><br>
                                        </div>
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4" style="height: 250px;">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Harga TK</h6>
                                </div>
                                <div class="card-body">
                                    <style>
                            ...
                            <div class="card shadow mb-4" style="height: 250px;">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Harga Pesantren</h6>
                                </div>
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Rp.100.0000-Rp.200.000</h4>
                                    <div class="progress mb-4">
