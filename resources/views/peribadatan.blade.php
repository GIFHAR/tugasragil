            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Peribadatan</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4" style="height: 250px;">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Harga Masjid</h6>
                                </div>
                                <div class="card-body">
                                    <style>
                                        .progress-bar.bg-dark-green {
                            ...
                            <div class="col-lg-16 mb-4">
                                ...
                                <div class="card mb-4 py-3 border-bottom-primary">
                                    <div class="card-body">
                                        <div class="card-body">
                                            Musholla   = 16-254 m<sup>2</sup><br>
                                            Masjid     = 103-116 m<sup>2</sup><br>
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4" style="height: 350px;">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Harga Musholla</h6>
                                </div>
                                <div class="card-body">
                                    <style>
                                        .progress-bar.bg-dark-green {
